 ...
 *
 * 参考：
 *   - 阶段 1.3 纯 Python 实现：traditional/stage_1_3_int_path/hc_adapter.py + hc_matmul.py
 *   - 静态预测试报告：traditional/stage_1_3_int_path/stage_1_3_preflight_static_review.md
 */
 ...
 * Python 参考实现：traditional/stage_2_3_int_path/hc_tree_unified.py
 *
 * 核心思想（与 UFP 串行残差链的区别）：
