 ...
 * @version 2.0.0
 *
 * 本文件包含所�?HC 变体共享的表驱动基础设施�? * 合并自原 hpdc_core.cpp（常量初始化、错误码）和 sgn_abi_dynamic.cpp（元数据表）�? *
 * 依赖：hc.h
 */
...
/* ============================================================================
 * 通用物理值计算（修复�?HC16 scale bug�? *
 * �?bug: hc16_physical_value() 起始 scale = 1.0/65536.0（错误！�? * 正确:   scale 起始�?1.0，每层除�?base
 * ============================================================================ */
