 ...
 * @version 2.0.0
 *
 * HC16: 4�?× 16位，基数 65536�? * 包含�?hpdc_core.cpp 中的 less/equal/to_double�? * 以及原缺失的 add_saturated/add_wrap/sub/soft_threshold/shift_right/checksum�? *
 * 依赖：hc16.h, hc.h
 */
